function(get_version OUTPUT)
    ...
    if(EXISTS ${VERSION_FILE_PATH})
        ...
        if(Git_FOUND)
            ...
            if(${GIT_DESCRIBE_RESULT} EQUAL "0")
                ...
                message(WARNING "${MESSAGE_ERROR_PREFIX} an error occurred when executing `git describe`, falling back to v0.0.0")
                set(VERSION_STRING "v0.0.0")
            endif()
        else()
            message(WARNING "${MESSAGE_ERROR_PREFIX} git is not available, falling back to v0.0.0")
            set(VERSION_STRING "v0.0.0")
        endif()
    endif()
    ...
    if(VERSION_REGEX_MATCH_RESULT STREQUAL ${VERSION_STRING})
        ...
        message(WARNING "${MESSAGE_ERROR_PREFIX} `${VERSION_STRING}` is not a valid version. The version must match the regex `${VERSION_REGEX}`! Falling back to 0.0.0")
